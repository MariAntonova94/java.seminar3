...
public class Main {
    public static void main(String[] args) {
        ...
        Items item4 = new Items("Мидии высший сорт", 759.99, 1);
        Items item5 = new Items("Соль высший помол йодированная", 62.0, 2);
        Items item6 = new Items("Устрицы высший сорт", 759.99, 2);
        Items item7 = new Items("Криветки королевские высший сорт", 759.99, 2);
